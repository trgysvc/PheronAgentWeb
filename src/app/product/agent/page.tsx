...
const HW_TIERS = [
  {
    ...
    models: "3B – 9B models",
    speed: "~30–120 tok/s",
    features: ["Titan Engine", "ANE Intent Classifier", "40+ Tools", "Quantized KV Cache"],
    highlight: false,
  },
  {
    ...
    speed: "~20–200 tok/s",
    features: ["Titan Engine", "ANE Intent Classifier", "40+ Tools", "Speculative Decoding", "Semantic Vision (24GB)"],
    highlight: true,
  },
  {
    ...
    speed: "~15–50 tok/s",
    features: ["Titan Engine", "ANE Intent Classifier", "40+ Tools", "Speculative Decoding", "65K Context (8-bit KV)"],
    highlight: false,
  },
  {
    ...
    speed: "~10–25 tok/s",
    features: ["Titan Engine", "ANE Intent Classifier", "40+ Tools", "Speculative Decoding", "131K Context (FP16 KV)"],
    highlight: false,
  },
];
