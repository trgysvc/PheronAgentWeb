...
const HW_TIERS = [
  {
    ...
    models: "3B – 9B models",
    speed: "~30–120 tok/s",
    features: ["Titan Engine", "ANE Intent Classifier", "59 Tools", "Quantized KV Cache"],
    highlight: false,
  },
  {
    ...
    speed: "~20–200 tok/s",
    features: ["Titan Engine", "ANE Intent Classifier", "59 Tools", "Speculative Decoding", "Semantic Vision (24GB)"],
    highlight: true,
  },
  {
    ...
    speed: "~15–50 tok/s",
    features: ["Titan Engine", "ANE Intent Classifier", "59 Tools", "Speculative Decoding", "65K Context (8-bit KV)"],
    highlight: false,
  },
  {
    ...
    speed: "~10–25 tok/s",
    features: ["Titan Engine", "ANE Intent Classifier", "59 Tools", "Speculative Decoding", "131K Context (FP16 KV)"],
    highlight: false,
  },
];
    ...
    <div className={styles.container}>
      ...
      <section className={styles.hero} style={{ paddingBottom: "60px" }}>
        ...
        <div className={styles.heroRequirement}>
          ...
          <span>macOS 26.0+ · Apple Silicon · 16 GB RAM minimum</span>
        </div>
      </section>
      ...
      <section className={styles.section} style={{ borderTop: "1px solid var(--border-glass)", paddingTop: "80px" }}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionSubtitle}>
            ...
            All tiers require macOS 26.0+ and Apple Silicon.
          </p>
        </div>
