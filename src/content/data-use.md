...
2. **License Validation**: Lemon Squeezy processes key validation on every app launch while online (falling back to a 24-hour offline grace period), verifying only the license key string and your device's hostname. Your purchase and billing records are stored by Lemon Squeezy under their own privacy policy; to remove that data, contact Lemon Squeezy directly in addition to any deletion request sent to us.
